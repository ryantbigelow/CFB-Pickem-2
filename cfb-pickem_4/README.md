...
3. **Deploy.** Push this folder to GitHub, import it in Vercel, and add the
   **four** environment variables from `.env.example` (see below). Invent your
...
— one line, safe to run twice.

### Adding the environment variables in Vercel

In Vercel: **your project → Settings → Environment Variables.**

Add these four, one at a time. For each, paste the name in **Key**, the value in
